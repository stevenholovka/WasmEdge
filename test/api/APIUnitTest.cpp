...
TEST(APICoreTest, TableType) {
  ...
  EXPECT_TRUE(WasmEdge_ValTypeIsEqual(WasmEdge_TableTypeGetRefType(TType),
                                      WasmEdge_ValTypeGenExternRef()));
  EXPECT_TRUE(WasmEdge_ValTypeIsEqual(WasmEdge_TableTypeGetRefType(nullptr),
...
TEST(APICoreTest, GlobalType) {
  ...
  EXPECT_TRUE(WasmEdge_ValTypeIsEqual(WasmEdge_GlobalTypeGetValType(GType),
                                      WasmEdge_ValTypeGenV128()));
  EXPECT_TRUE(WasmEdge_ValTypeIsEqual(WasmEdge_GlobalTypeGetValType(nullptr),
                                      WasmEdge_ValTypeGenI32()));
...
TEST(APICoreTest, ImportType) {
  ...
  EXPECT_TRUE(WasmEdge_ValTypeIsEqual(
...
TEST(APICoreTest, ExecutorWithStatistics) {
  ...
  EXPECT_TRUE(WasmEdge_ValTypeIsEqual(R[0].Type, WasmEdge_ValTypeGenI32()));
  EXPECT_EQ(912, WasmEdge_ValueGetI32(R[1]));
  EXPECT_TRUE(WasmEdge_ValTypeIsEqual(R[1].Type, WasmEdge_ValTypeGenI32()));
  EXPECT_TRUE(
      isErrMatch(WasmEdge_ErrCode_WrongVMWorkflow,
